...
import permission from "../assets/workspace_image/permission.svg";
...
export const DropDownDocument2 = ({ open, setOpen }) => {
          ...
          <div className="flex flex-col py-3 md:py-2">
            ...
            <div className="relative">
              <button
                className={
                  openExport
                    ? "flex items-center text-20px gap-x-4 px-5 py-3 w-full bg-[#f4f4f4] md:text-14px md:py-2 md:gap-x-3"
                    : "flex items-center text-20px gap-x-4 px-5 py-3 w-full hover:bg-[#f4f4f4]  md:text-14px md:py-2 md:gap-x-3"
                }
                onClick={() => setOpenExport(!openExport)}
              >
                <img src={permission} className="md:w-5" />
                <span>Permission</span>
                <span className="absolute right-5 w-[8px] h-[16px] md:w-[6px] md:h-[13px]">
              ...
              {openExport ? (
                <span className="absolute -right-40 -top-56 -mr-2 lg:right-72 lg:mr-0 md:right-80 md:-top-7 md:mt-4 md:-mr-1">
            ...
            {/*Remove member */}
            <button
              className="flex items-center text-20px gap-x-4 text-red-500 px-5 py-3 hover:bg-[#f4f4f4] w-full  md:text-14px md:py-2 md:gap-x-4"
              type="button"
              onClick={() => setDeleteDocument(!deleteDocument)}
            >
              <img src={trush} className="md:w-4"/>
