...
export const DropDownFilterDocument = ({ openFilter, setOpenFilter }) => {
  return (
    <div>
      {openFilter && (
        <div
      ...
      <div className="text-18px absolute z-50 left-0 mt-1 w-full text-accent rounded-lg shadow-md bg-white xs:w-36 md:w-52 2xs:w-32 lg:w-full">
