          ...
          <div className="absolute z-20 mt-24 space-x-52 grid grid-cols-12 justify-center lg:px-20 md:-ml-20 md:space-x-0 md:absolute">
                  ...
                  {/*logo  */}
                    <div className="col-span-4 -mt-32 lg:-mt-16 lg:col-span-12 md:relative md:-mt-4">
                                    <img src={logo} className="w-32 ml-28 lg:ml-10 lg:w-24 md:w-14 md:ml-40 md:-mt-16"/>
                                    <div className="font-semibold text-20px text-white mt-5 lg:-ml-20 md:w-[250px] md:absolute md:mt-4 md:ml-16 md:text-sm">© 2023 DocEngine Inc. All rights reserved.</div>
                    </div>

                    {/*Tittle  */}
                    <div className="col-span-4 items-center -mt-44  md:mt-32">
                              <span className="absolute lg:-mt-10 lg:-ml-48 md:-ml-5 md:-mt-16"><img src={text} className="ml-36 mt-10 lg:hidden lg:w-[280px] md:w-[150px]" /></span>
                              <span className="-mt-24 absolute lg:ml-20 lg:mt-36 md:-mt-24 md:-ml-20"><img src={pic_footer_right} className="w-32 ml-60 lg:-mt-24 lg:w-20 md:ml-28 md:w-16" /></span>
                    </div>
          </div>
