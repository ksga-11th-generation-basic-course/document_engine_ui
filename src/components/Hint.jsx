  ...
  return (
    <div className=" md:-ml-5">
      <div className="mb-5 mt-7">
        ...
        <p className="-mt-1 text-accent text-20px  md:text-11px">
        ...
        <div>
          {open ? (
            <div className="absolute w-full text-accent rounded-b-lg border-t-[1px] border-r-[15px] border-r-primary shadow-custom bg-white z-50">
              <div className="flex flex-col gap-y-5 py-5 px-5 md:px-4 md:w-full md:py-3">
                {/* Join Workspace */}
                <div>
                  ...
                  <span>Hint :</span>
                    <span className=" text-accent text-md font-normal ml-1">
