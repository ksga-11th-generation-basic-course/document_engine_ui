      ...
      <div className="sm:block md:block  hidden dropdown relative ">
            <div className="dropdown dropdown-end  relative">
              ...
              <ul tabIndex={0} className="menu menu-compact gap-2 dropdown-content mt-5 p-4 text-center  bg-sky-100 max-lg:hidden max-md:hidden border-primary border-2 shadow-lg absolute right-0 rounded-box w-[345px] md:[]">
                <li><NavLink   to={"/"} className="hover:bg-sky-400 hover:text-white text-center bg-primary md:p-3 text-white">Home</NavLink> </li>
                <li><NavLink   to={"/aboutus"} className="hover:bg-sky-400 hover:text-white text-center bg-primary md:p-3 text-white"> About Us</NavLink></li>
                <li><NavLink  to={"/contactus"} className="hover:bg-sky-400 hover:text-white text-center bg-primary md:p-3 text-white "> Contact Us</NavLink></li>
              </ul>
          </div>
      </div>
   </div>  
