...
import SettingIcon from '../assets/reset_pw_popup/settingIcon.svg'

function SideBarOwnerPopup() {
  return (
    <div>
    <div className="h-[650px] shadow-lg bg-[#FFFFFF] w-64 rounded-md shadow-content">
        ...
        <div className="pr-16 pl-6">                
              ...
              <div className='ml-2 flex'>
                            ...
                            <label className='text-[#526581] ml-4 font-semibold'>Setting</label>
                        </div>
                    <div className="shadow-lg relative bg-[#F6F6F6] mt-4 mb-5 px-2.5 py-2 rounded-lg ">
                    
                        <div className='ml-2 flex '>
                            <img src={PersonTwo}></img>
                            <label className='text-[#1E9CEF] ml-4 font-semibold'>Collabrators</label>
                        </div>
...
export default SideBarOwnerPopup