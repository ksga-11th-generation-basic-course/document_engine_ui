...
export default function Sidebar() {
  return (
    <div>
      <div className="h-screen shadow-sm-light bg-[#FAFAF9] w-64 fixed">
            {/* Logo */}
            ...
            <div className="flex justify-center m-5">
              <button className="rounded py-2 w-[215px] bg-blue-500 hover:bg-blue-700 text-white font-normal">
                New workspace
              </button>
            </div>
                    ...
                    <NavLink to="/dashboard" className={({isActive}) => isActive? "fill-primary text-primary" : "fill-accent text-accent"}>
                          <span className="flex">
                                    <span className="flex pr-4">
                                          <svg width="20" height="20" viewBox="0 0 15 18"  xmlns="http://www.w3.org/2000/svg">
