...
function SkeletonDocumentRow() {
  return (
    <div className="flex justify-between items-center px-8 gap-x-5 w-full shadow-custom rounded-lg cursor-pointer lg:w-full md:-ml-5 md:px-4 md:w-[350px] md:py-2.5 md:pl-5 hover:shadow-hover">
