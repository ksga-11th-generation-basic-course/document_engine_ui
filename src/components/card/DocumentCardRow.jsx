...
export const DocumentCardRow = ({
  ...
  return (
    <div className="flex justify-between items-center gap-x-5 w-full px-5 py-4 shadow-custom rounded-lg cursor-pointer hover:shadow-hover 
    lg:w-full md:-ml-5 md:px-4 md:w-[440px] md:py-2.5 md:pl-5 ">
      <div>
        ...
        <p className="text-accent text-16px text-left md:text-10px md:text-10px">
          Edited {editDate}
        </p>
      </div>
