...
export const DocumentPermissionModal = ({
  ...
  return (
    <div className="w-full ">
      ...
      >
        <div className="w-[1200px] h-[810px] bg-white rounded-lg grid grid-cols-12 relative lg:w-[700px] lg:bg-inherit md:w-[500px] ">
          ...
          <div className="col-span-9 p-3 shadow-xl lg:bg-white lg:rounded-lg lg:w-[700px] md:bg-white md:rounded-lg md:w-[500px]">
            <div>
