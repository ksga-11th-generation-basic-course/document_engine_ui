      ...
      <Modal open={visible}>
        <div className="w-[540px] bg-white rounded-lg p-3 md:w-[300px] md:p-2.5">
          <div className="flex justify-end">
            <button type="button" onClick={() => toggleVisible(!visible)}>
              <img src={close}  className="md:w-6"/>
            </button>
          </div>
          <div className="px-14 space-y-2 text-accent md:space-y-4 md:px-2">
            ...
            <h1 className="font-bold text-24px text-primary text-center md:text-20px md:mb-3">
              Comeback soon!
              <p className="font-normal text-accent text-24px text-center md:text-15px md:mt-2">
