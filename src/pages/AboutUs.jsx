  ...
  return (
    <div className="bg-white overflow-hidden sm:overflow-hidden">
      ...
      <div className="mt-10 -mb-20 md:mt-0">
        ...
        <div className="Member flex justify-center items-center lg:inline-block lg:ml-24 lg:mt-14 md:px-5 md:ml-2 md:ml-0 md:mt-5">
          ...
          <div className="text-20px space-y-8 lg:-mt-[280px] lg:ml-[350px]  lg:space-y-7 md:text-12px md:ml-44 md:-mt-[220px]">
            <div className=" bg-[#EDF9FF] w-fit px-4 py-2 rounded-2xl space-x-2">
            <span className="shadow-icon2 px-2 py-1 rounded-full text-primary font-semibold">
                <span>@</span>
              </span>
