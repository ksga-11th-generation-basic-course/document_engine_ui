...
export const AboutUs = () => {
  return (
    <div className="bg-white overflow-hidden sm:overflow-hidden">
      ...
      {/*  */}
      <div className="SlideBar pt-[76px] sm:pt-[70px]  md:pt-[32px] lg:pt-[78px]">
        <div className="SlideBar2 relative ">
          <div className="absolute left-0  text-6xl xl:top-24 font-bold top-44  text-primary px-20 sm:-left-10 lg:top-12 lg:-left-5 lg:text-5xl  md:-mt-6 sm:text-24px sm:top-7 sm:leading-6 ">
            <h1 className="sm:whitespace-nowrap ">What & Who</h1>
            <h1 className="sm:whitespace-nowrap md:-mt-6">We Are</h1>
          </div>
        </div>
      ...
      {/* Our members */}
      <div className="mt-10 -mb-20 md:mt-0">
        ...
        <div className="Member flex justify-center items-center lg:inline-block lg:ml-24 lg:mt-14 md:ml-1 md:mt-5">
          <div className="text-22px space-y-7 md:text-12px md:ml-4">
            ...
            <div className=" bg-[#EDF9FF] w-fit  px-4 py-2 rounded-2xl space-x-2 ml-8 lg:ml-0">
