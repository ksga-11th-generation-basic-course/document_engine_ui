    ...
    <div className="bg-white overflow-hidden sm:overflow-hidden">
      ...
      <div className="mt-10 -mb-20 md:mt-0 lg:-mb-40">
        ...
        <div className="Member my-20 flex justify-center items-center lg:inline-block lg:ml-3 lg:mt-14 sm:px-5 md:-ml-2  md:mt-5 md:space-y-6">
          ...
          <div className="text-20px space-y-10 lg:space-y-10 lg:-mt-[195px] lg:ml-[410px] md:w-[200px] md:space-y-10 md:text-12px md:ml-32 md:-mt-[190px]">
            <div className="flex -ml-14 lg:-ml-14 md:mt-10">
              <Avatar
                className="w-16 h-16 rounded-full ring ring-primary ring-offset-base-100 ml-6 ring-offset-2 md:w-[40px] md:h-[40px]  "
                src={Raksa}
              />
          ...
          <div>
            <p
              className="hidden lg:inline-block text-primary text-28px font-semibold mt-24 ml-36 
          lg:ml-60 lg:w-[300px] lg:-pt-2 lg:text-center  lg:bg-[#EDF9FF] lg:rounded-3xl   md:text-16px md:ml-24  md:w-[200px] md:bg-[#EDF9FF] md:h-8 md:mt-10"
            >
              www.docengine.tech
            </p>
          </div>
