...
export default function AboutUs() {
  return (
    <div className='about w-full'>
        ...
        <div className='flex flex-row max-sm:flex-col w-screen justify-evenly px-20 max-sm:px-10 '>
            <div className=' flex flex-col   '>
                <div className="mainTitle font-bold text-4xl pt-36 max-sm:pt-16 max-sm:text-2xl">
                    <h1 className='pb-35 text-accent'>All your <span className='text-primary pr-2'>Documents</span >in one <span className='text-primary '> place</span></h1>
                    <h1 className='text-accent'>and<span  className='text-primary p-2'>safe! </span></h1>
                </div>
                <div className="pt-10 leading-normal text-2xl w-96  max-sm:px-2 max-sm:text-xl text-[#575E69]">
                     DocEngine is a system that includes the possibility to
                    customize the document with auto-saving and ease
                    when the users want to share those documents 
                    within the group.
                </div>
            </div>
           <div className="img ">
            ...
            <div className=' flex justify-evenly max-sm:flex-col  items-center py-16 max-sm:py-6 '>
                <div className=' flex justify-center flex-col max-sm:hidden  max-sm:text-xl max-sm:flex-row max-sm:pb-10'>
                    ...
                    <div className='text-5xl max-sm:text-4xl font-bold text-accent'>
                        <h1>Why</h1>
                        <h1>Doc <span className='text-primary'>Engine?</span></h1>
                    </div>
                </div>
                <div className='max-sm:indent-[0.5px] max-sm:text-xl   max-sm:border-2 max-sm:border-primary max-sm:py-3 max-sm:px-0 '>
                    <h1 className='text-4xl text-center max-sm:text-4xl max-sm:text-center font-bold text-accent'>About Our <span className='text-primary'>Project </span></h1>
        ...
        <h1 className='text-4xl text-center w-full pt-10 max-sm:pt-2 max-sm:text-2xl text-accent font-bold'>Our<span className='text-primary pl-2'>Members </span></h1>
