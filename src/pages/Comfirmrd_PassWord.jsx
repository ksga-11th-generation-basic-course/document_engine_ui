      ...
      <div className='bg'>
        ...
        <div className="bg-white flex flex-col absolute   justify-center gap-y-6 rounded-3xl shadow-md">
            ...
            <div class="text-main pt-5">
                <h1 class="font-bold text-center text-blue-500 text-2xl">New Password <p>confirmed successful</p></h1>       
            </div>  
            <div className="text pt-5">
                <p class="text-sm text-gray-500 px-6">You have successful confirmed your new password.
                use your</p>  
                <p class="text-sm text-center text-gray-500 px-6">Please, use your new password when  signing in.</p>  
            </div>
