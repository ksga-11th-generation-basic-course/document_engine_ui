            ...
            <div className=' grid grid-cols-1 lg:grid-cols-2   '>
                <div className=' m-28'>
                    ...
                    <div className="text pt-8">
                        <h2 className="text-4xl font-bold pb-5 text-accent">Let's <span className='text-primary'>Talk!</span></h2>
                    ...
                    <div className="form relative top-10">
                        <label htmlFor="" className='text-xl text-[#575E69] font-semibold'>Your Email @</label>
