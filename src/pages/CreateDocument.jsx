          ...
          <div className="w-full grid grid-cols-12 gap-y-2">
            ...
            <div className="col-span-12 text-sm relative">
              <div className="relative grid grid-cols-12">
                <span className="col-span-3 gap-x-3 w-36">
                  <div className="flex gap-x-3">
                  <img src={Tag} className="w-[16px]" alt="" />
                  <p>Tag</p>
                  </div>
                </span>
                <button className="flex items-center col-span-9">
                  {tags.map((tag, index) => (
                    <span
                      key={index}
                      className="inline-flex gap-1 items-center bg-gray-100 text-gray-800 rounded-full text-sm font-medium"                >
                      {tag}
                  ...
                  {!toggle && (
                    <div onClick={() => setToggle(!toggle)} className='text-sm cursor-pointer font-medium px-4 shadow rounded-full flex justify-center items-center gap-1 text-[#1E9CEF]'>
                      Add Tag
