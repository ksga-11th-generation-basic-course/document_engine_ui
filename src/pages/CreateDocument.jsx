      ...
      <div className="text-[#9CA3AF] grid grid-rows-1 gap-2 ">
        <div className="w-full h-auto">
          ...
          <span className="font-semibold">
            <input
              className="text-5xl sm:text-3xl p-0 sm:py-5 sm:mt-4 text-black focus:ring-0 focus:border-0 border-0"
              type="text"
              placeholder="Untitle"
            />
          </span>
          <div className="w-[40%] sm:w-full sm:p-2 grid grid-rows-1 gap-y-2">
            <div className="grid grid-cols-2 text-sm sm:py-1">
