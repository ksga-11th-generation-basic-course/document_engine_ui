        ...
        <div className="mt-10 px-44">
          <div className="w-full">
            ...
            <div>
              ...
              <p className="mt-2 text-24px text-[#526581]">
            ...
            <div className="mt-7">
              ...
              <div className="flex">
                <img
                  src={document}
                  className="bg-white rounded-lg shadow-custom p-2"
                />
                <p className="flex items-center ml-4 font-semibold  text-20px text-accent">
                  Recently
                </p>
              </div>
                  ...
                  <div className="col-span-11">
                    <div>
                      <div className="flex items-center">
                        <p className="text-22px font-semibold w-36">
                          Spring Profile
                        </p>
                        <p className="ml-7 bg-[#EDF9FF] px-5 rounded-lg flex">
                          <span className="text-[#1E9CEF] text-12px">
                            Editing...
                          </span>
              ...
              <div className="mt-5">
                <div className="bg-white shadow-custom px-8 py-4 rounded-lg grid grid-cols-12">
                  <div className="col-span-11">
                    <div>
                      <div className="flex items-center">
                        <p className="text-22px font-semibold w-40">
                          Redux Toolkit
                        </p>
                      </div>
                      <div>
