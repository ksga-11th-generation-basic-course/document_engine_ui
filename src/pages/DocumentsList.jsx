          ...
          <div className="m-auto w-[900px] h-auto text-[#526581] grid grid-rows-1 gap-2">
            <div className="w-full h-auto">
              ...
              <p className="font-medium text-[15px]">
                Welcome to React Developer workspace
              </p>
            </div>
            <div className="w-full h-auto flex justify-between">
              ...
              <div>
                <a
                  href="#_"
                  class="inline-flex items-center justify-center px-3 py-2 text-sm font-medium leading-3 text-white whitespace-no-wrap bg-blue-600 border border-blue-700 rounded-md shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
