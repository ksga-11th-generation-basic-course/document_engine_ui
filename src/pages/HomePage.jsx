  ...
  return (
    <div className='home_page'>
        ...
        <div className="main grid grid-cols-3 gap-2 relative px-20">
            ...
            <div className='right pt-20 col-span-2'>
                <img src={Pic} alt="" />
            </div>
        </div>  
        ...
        <div className='card w-full px-20 pt-10'>
        ...
        <div className='tool px-56 pt-24 w-full'>
            <div className="flex justify-between w1/2">
                <div className="text text-justify">
                    <h1 className='text-5xl'>Learn the best <span className='text-blue-400'>tools</span></h1>
                    <h1 className='text-5xl pt-5'>and <span className='text-blue-400'>platforms</span></h1>
                    <div className='paragraph text text-justify pt-4'>
                ...
                <div className="icon w-1/3 pt-16 flex justify-center">
                    <div className="icon1 pr-10">
                        <img src={Icon1} alt=""  className='w-16 hover:scale-125  '/>
                    </div>
