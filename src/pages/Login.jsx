...
const Login = () => {
  return (
    <div className="flex px-2 justify-center items-center bg-[#EDF9FF] text-[#37352F]">
        ...
        <div className="bg-white p-6 flex flex-col justify-center gap-y-4 rounded-3xl shadow-md">
            <div class=" xs:p-0 mx-auto md:w-full md:max-w-md">
                        <h1 class="font-bold text-center text-blue-500  text-2xl">Sign in</h1> 
                        <div class="px-5 py-5">
                            <label class="font-semibold text-sm text-gray-600  block">Email</label>
                            <input type="email" class="border border-blue-400 rounded-lg px-2 py-3 mt-1 mb-5 text-sm w-full"  placeholder='example@gmail.com'/>
                            <label class="font-semibold text-sm text-gray-600 block">Password</label>
                            <input type="text" class="border border-blue-400 rounded-lg px-2 py-3 mt-1 mb-5 text-sm w-full"  placeholder='Password' />
                        <button type="button" class="transition pb-4 duration-200  w-full py-2.5  text-sm  font-semibold text-left inline-block">
                            Forgot your password?
                        </button> 
                        <button type="button" class="transition  duration-200 bg-primary hover:bg-blue-400 focus:shadow-sm focus:ring-4 focus:ring-blue-500 focus:ring-opacity-50 text-white w-full py-2 rounded-lg text-sm shadow-sm hover:shadow-md font-semibold text-center inline-block">
                            Sign in
                        </button>
                        <button type="button" class="transition  duration-200 text-primary pt-5 w-full py-2  text-sm  font-semibold text-center inline-block">
                            Sign in
                        </button>
                    </div>
                    ...
                    <div class="p-2">
                      <div class="grid grid-cols-2 gap-6">
                          <button            class="flex justify-center items-center  py-2 px-4 text-sm uppercase rounded bg-white border border-gray-300  hover:text-gray-700  font-bold transition transform "          >
                          ...
                          <button            class="flex justify-center items-center py-2 px-4 font-bold text-sm uppercase rounded border border-gray-300     hover:text-gray-700   transition transform "          >
                              <svg
