  ...
  return (
    <div className='w-full fixed z-10'>
        ...
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between py-4 ">
                ...
                {/* <div className="sm:hidden  form-control">
                    <input type="text" placeholder="Search" className="input input-bordered px-2  py-2 border rounded-lg border-accent" />
                    </div> */}
        ...
        {/* <div class="bg-secondary font-sans w-full  m-0">
            <div class="bg-secondary shadow">
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between py-4 max-sm:py-12">
                <div className=' '>
                    <img src={Logo} className="absolute max-sm:left-8 max-sm:top-4 max-sm:w- w-16 h-16 top-1 mb-8 left-12" />
                </div>
