          ...
          <div className="mx-auto">
            <div className="flex items-center justify-between py-1 px-16">
              ...
              <div className="max-sm:absolute max-sm:right-14 text-sm">
                <Link
                  to={"signin"}
                  className="text-accent text-22px max-sm:bg-accent max-sm:py-2 max-sm:px-2 max-sm:mr-5 mr-3  max-sm:rounded-lg font-semibold max-sm:hover:text-white hover:text-primary outline-none"
                >
                  Sign in
                </Link>
                <Link
                  to={"signup"}
                  className="text-white text-22px font-semibold px-5 py-2 bg-primary max-sm:py-2 max-sm:px-2 border-primary border-2 rounded-xl"
                >
                  Sign up
                </Link>
              </div>
