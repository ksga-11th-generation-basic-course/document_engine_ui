    ...
    <div className='notFound bg-[#EDF9FF] h-[100vh] w-full '>
       <div className="navbar">
        ...
        <div className='flex flex-col justify-center items-center max-sm:pt-20 lg:pt-16'>
            ...
            <div className='text'>
                <h1 className='lg:text-7xl max-sm:text-center text-primary max-sm:text-5xl max-sm:drop-shadow-2xl max-sm:shadow-accent font-bold'>Page Not Found</h1>
                <p className='text-back text-center pt-5 text-xl max-sm:text-lg'>Sorry, we can’t find the page you looking for.</p>
