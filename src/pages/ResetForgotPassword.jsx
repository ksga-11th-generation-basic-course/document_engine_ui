          ...
          {/* <!-- component --> */}
            ...
            <div
              ...
              <div className="flex  items-center mt-20 w-full lg:pt-20 ">
                ...
                <form className="bg-white p-10 flex  justify-center  rounded-3xl shadow-md lg:mb-44 lg:w-[500px] lg:pb-8 md:p-1 md:-mt-6 md:w-[290px] md:pb-8">
                  <div className="  ">
                    <div className=" w-full  ">
                      <h1 className="font-bold text-center text-primary text-36px text-2xl lg:mb-4 lg:mt-10 md:text-xl md:mb-0 ">
                        Set New Password
                      </h1>
                                ...
                                <p className="text-18px text-accent text-base lg:text-xl lg:text-22px lg:pb-4 lg:pl-4 md:text-sm  ">
                                  ...
                                  >
                                    ...
                                    <div className="relative">
                                      <p className="font-semibold text-left pt-5 pb-2 text-black text-base lg:text-xl lg:text-22px md:text-base md:pt-1 ">
                                        New Password
                                      </p>
                                      <input
                                    ...
                                    <div className="relative">
                                      <p className="font-semibold text-left pt-5 pb-2 text-black text-base lg:text-xl lg:text-22px md:text-base">
                                        Confirm New Password
                                      </p>
                                      <input
                                        placeholder="Your New Password"
