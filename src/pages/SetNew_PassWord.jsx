  ...
  return (
    <div>
        ...
        <div class="flex flex-col items-center justify-between pt-0 pr-10 pb-0 pl-10 mt-0 mr-auto mb-0 ml-auto max-w-7xl
          ...
          <div class=" xs:p-0 mx-auto md:w-full px-5  md:max-w-md  ">
                <div class="bg-white w-full  ">
                    <h1 class="font-bold text-center text-blue-400 text-4xl">Set New Password?</h1> 
                    <div>
                    <div class="py-8 ">
                        <div class="container mx-auto">
                            <div class="max-w-sm mx-auto md:max-w-lg">
                                <div class="w-full">
                                    ...
                                    <div className="text">
                                        <p class="text-l text-gray-500 ">Password must be at least 8 characters.
                                        </p>  
                                            {/* <p class="text-l text-center text-gray-500">password reset instructor</p>   */}
                                     </div>
                                    <div class="relative">
                                        <p className='text-left pt-4 '>New Password</p>
                                        <input placeholder="Your New Password" type="text" class="border placeholder-gray-400 focus:outline-none
