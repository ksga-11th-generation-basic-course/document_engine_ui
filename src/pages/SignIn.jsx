...
const SignIn = () => {
  return (
        <div className="flex px-2 justify-center items-center bg-[#EDF9FF] text-accent">
                    <div className="flex justify-center items-center min-h-screen relative overflow-hidden">
                        ...
                        <div className="bg-white p-10 flex flex-col justify-center gap-y-4 rounded-3xl shadow-md">
                            <div className=" xs:p-0 mx-auto w-[380px] md:max-w-md">
                                ...
                                <a href="#_" class="px-5 py-2.5 font-semibold relative group overflow-hidden bg-primary w-full text-center rounded-lg text-white hover:ring-2 inline-block hover:ring-offset-2 hover:ring-blue-400 transition-all ease-out duration-1000">
                                    <span class=" absolute right-0 w-8 h-32 -mt-12 transition-all duration-1000 transform translate-x-28 bg-white opacity-10 rotate-12 group-hover:-translate-x-40 ease"></span>
                ...
                <img className="w-[505px] h-[445.57px] ml-1 max-sm-hidden" src={RightImage} /> 
        </div>
  );
};
