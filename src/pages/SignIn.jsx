...
import signInLeft from "../assets/images/Left/signInLeft.svg";
import signInRight from "../assets/images/Right/signInRight.svg";
            ...
            <div>
                ...
                <div className="grid grid-cols-3 h-screen bg-[#EDF9FF]">
                    ...
                    <div className="flex justify-end">
                        <img className="w-[260px]" src={signInLeft} />
                    </div>
                    {/* form  */}
                    <div className="flex items-center justify-center">
                        <div className="border bg-white p-10 rounded-3xl shadow-lg w-[400px] h-[515px]">
                            ...
                            <div>
                                ...
                                <button
                                    type="button"
                                    className="text-sm py-4 font-ssp font-bold text-gray-500 text-left">
                                ...
                                <div>
                                    ...
                                    <button
                                        type="button"
                                        className="text-primary pt-3 w-full font-bold text-sm text-center">
                                        Sign up
                                    </button>
                                </div>
                            </div>
                    ...
                    <div className="flex justify-start items-center">
                        <img className="w-[370px] h-[600px]" src={signInRight} />
                    </div>
                </div>
            </div>
        );
