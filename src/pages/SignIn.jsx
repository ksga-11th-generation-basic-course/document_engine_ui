...
export const SignIn = () => {
  ...
  return (
    <div className="flex justify-center items-center bg-[#EDF9FF] text-accent lg:justify-start md:justify-center">
      <div className="flex justify-center items-center min-h-screen relative overflow-hidden">
        <Link to={"/"}>
          <img
            src={Logo}
            className="absolute top-8 left-8 lg:left-36 lg:-ml-2 md:left-6 md:w-[60px] md:h-[60px]"
          />
        </Link>
        ...
        <form
          ...
          className="bg-white  p-12 flex flex-col justify-center gap-y-6 rounded-3xl shadow md:max-w-md -ml-16 lg:ml-32
           lg:mt-28 lg:pt-5 lg:-mr-1 lg:px-12 lg:w-[500px] lg:pb-10  md:w-[335px]  md:p-0 md:py-3 md:m-0 md:mt-16 md:bg-white md:shadow-none md:justify-center md:items-center">
            <h1 className="font-bold text-center text-primary text-36px max-sm:pt-5 max-sm:text-4xl md:items-center 
             lg:text-4xl  lg:mt-6 md:text-2xl">
              Sign in
            </h1>

            <div className="px-2 lg:text-2xl -mb-3 md:ml-36">
              {/* Email */}
              ...
              <div className=" max-sm:flex max-sm:items-center max-sm:border-b pb-25px max-sm:border-primary lg:mr-32 md:-mt-2">
                <input
                  className="border-primary focus:border-btn-primary focus:ring-btn-primary text-18px border
                   ...
                   w-full text-gray-700 mr-3  leading-tight focus:outline-none lg:w-[370px] lg:h-12 lg:text-18px md:h-8 md:rounded-md md:w-[275px] md:text-sm"
                  type="text"
              ...
              <input
                  className="border-primary focus:border-btn-primary focus:ring-btn-primary text-18px border
                  rounded-lg px-2 py-3 max-sm:appearance-none max-sm:bg-transparent max-sm:leading-tight max-sm:border-none 
                  w-full text-gray-700 mr-3  leading-tight focus:outline-none lg:w-[370px] lg:h-12 lg:text-18px md:h-8 md:rounded-md md:w-[270px] md:text-sm"
              ...
              <button
                type="submit"
                className="h-[48.5px] px-2 py-3 transition duration-200 bg-primary hover:bg-btn-primary focus:shadow-sm text-white w-full rounded-lg 
              ...
              <Link
                ...
                text-center inline-block  lg:text-22px md:text-base lg:pr-5  md:pr-40 md:-mt-2"
              >
                Sign up
              </Link>
            </div>
            ...
            {/* ---------or------- */}
            <div className="-my-2 lg:ml-2 md:ml-0">
              ...
              after:border-t after:border-neutral-400 md:pl-1 md:w-[270px] ">
            ...
            <div className="">
              <div className="grid grid-cols-12 gap-4 lg:gap-3 lg:ml-2  md:ml-2 ">
                {/* Google */}
                <div className="col-span-6 lg:col-span-12 md:pl-0">
                <button
                  ...
                  className="flex  rounded-lg justify-center items-center py-2 text-sm w-full border border-gray-200  outline-none max-sm:border-primary
                    text-accent font-bold transition transform lg:w-[370px] md:h-[37px] md:w-[270px] md:pl-6  "
                >
                ...
                {/* Facebook */}
                <div className="col-span-6 lg:col-span-12 md:pl-0 md:pb-7">
                  <button
                    ...
                    text-accent transition transform lg:w-[370px]  md:h-[37px] md:w-[270px] gap-x-1.5 md:gap-x-0.5"
                  >
