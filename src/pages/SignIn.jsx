...
const SignIn = () => {
  return (
    <div className="bg-[#EDF9FF] text-accent px-24 py-7">
        <img src={Logo} className="" />
      <div className="flex justify-center items-center min-h-screen relative overflow-hidden">
        <img
          className="w-[450px] h-[426.16px] mr-5  max-sm-hidden"
          src={LeftImage}
        />
        <div className="bg-white p-10 flex flex-col justify-center gap-y-4 rounded-3xl shadow-md">
          <div className=" xs:p-0 mx-auto w-[380px] md:max-w-md">
            ...
            <div className="px-5 py-5">
              ...
              <input
                type="email"
                className="border border-primary outline-blue-500  rounded-lg px-2 py-3 mt-1 mb-5 text-sm w-full"
                placeholder="example@gmail.com"
              />
              <label className="font-semibold text-sm block">Password</label>
              <input
                type="text"
                className="border border-primary outline-blue-500 rounded-lg px-2 py-3 mt-1 mb-3 text-sm w-full"
                placeholder="Password"
              />
              <button
                type="button"
                className="transition duration-200 w-full py-2.5 mb-3 text-sm font-semibold text-left inline-block"
              >
                Forgot your password?
              </button>
              <button className="px-5 py-2.5 font-semibold relative group overflow-hidden bg-primary w-full text-center rounded-lg text-white hover:ring-2 inline-block hover:ring-offset-2 hover:ring-blue-400 transition-all ease-out duration-1000">
                <span className=" absolute right-0 w-8 h-32 -mt-12 transition-all duration-1000 transform translate-x-28 bg-white opacity-10 rotate-12 group-hover:-translate-x-40 ease"></span>
                <span className="relative">Sign in</span>
              </button>
              <button
                type="button"
                className="transition duration-200 text-primary pt-5 w-full font-semibold text-center inline-block"
              >
                Sign up
              </button>
            </div>
      ...
      <img
        className="w-[505px] h-[445.57px] ml-1 max-sm-hidden"
        src={RightImage}
      />
    </div>
  );
