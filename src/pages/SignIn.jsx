  ...
  return (
        <div className="flex px-2 justify-center items-center bg-[#EDF9FF] text-accent">
                    <div className="flex justify-center items-center min-h-screen relative overflow-hidden">
                        <img src={Logo} className="absolute top-5 left-28" />
                        <img className="w-[800px] h-[550px] mr-5 max-sm-hidden" src={LeftImage} />
                        <div className="bg-white p-10 flex flex-col justify-center gap-y-4 rounded-3xl shadow-md">
                            <div className=" xs:p-0 mx-auto w-[380px] md:max-w-md">
                                ...
                                <div className="px-5 py-5">
                                    ...
                                    <button type="button" className="transition duration-200 w-full py-2.5 mb-3 text-sm font-semibold text-left inline-block">
                ...
                <img className="w-[800px] h-[600px] ml-1 max-sm-hidden" src={RightImage} /> 
        </div>
  );
};
