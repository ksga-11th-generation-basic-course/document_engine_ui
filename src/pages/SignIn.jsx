  ...
  return (
    <div className="flex justify-center items-center bg-[#EDF9FF] text-accent">
      ...
      <div className="flex justify-center items-center min-h-screen relative overflow-hidden">
        ...
        >
          <div className=" xs:p-0 mx-auto w-fit md:max-w-md">
            ...
            <div className="px-2 py-30px max-sm:py-8 max-sm:px-8">
              ...
              <div className=" max-sm:flex max-sm:items-center max-sm:border-b pb-25px max-sm:border-primary ">
                <input
                  className="border-primary focus:border-btn-primary focus:ring-btn-primary text-18px border rounded-lg px-2 py-3 max-sm:appearance-none max-sm:bg-transparent max-sm:leading-tight max-sm:border-none w-96 text-gray-700 mr-3  leading-tight focus:outline-none"
                  type="text"
