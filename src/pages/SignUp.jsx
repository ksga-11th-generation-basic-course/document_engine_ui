  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      password: Yup.string()
        ...
        .matches(/^(?=.*[A-Za-z])(?=.*d)(?=.*[@$!%*#?&])[A-Za-zd@$!%*#?&]{8,}$/, "Must Contain 8 Characters, One Uppercase, One Lowercase, One Number and one special case Character"),
            ...
            <div className="p-2">
              <div className="grid grid-cols-2 gap-3  md:flex flex-col-reverse">
                ...
                >
                    ...
                    <span className="text-20px text-black lg:text-2xl md:text-base">Google</span>
                </button>
