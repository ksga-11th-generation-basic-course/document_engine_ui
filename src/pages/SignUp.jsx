...
export const SignUp = () => {
  ...
  return (
    <div className="flex px-2 justify-center items-center bg-[#EDF9FF] text-accent lg:bg-[#EDF9FF]">
      <div className="flex justify-center items-center min-h-screen relative overflow-hidden">
        ...
        <form
          ...
          className="bg-white max-sm:bg-[#EDF9FF] p-12 flex flex-col justify-center gap-y-6 rounded-3xl 
          ...
          <div className=" xs:p-0 mx-auto w-[380px]  md:ml-3">
           ...
           {/* ------- or -------- */}
            <div className="px-4 pb-4 ">
              <div className="flex items-center before:mt-0.5 before:flex-1 before:border-t before:border-neutral-400 after:mt-0.5 after:flex-1 after:border-t
               after:border-neutral-400 md:w-[200px]">
                <p className="mx-1 text-center text-gray-400 lg:text-2xl md:text-base">or</p>
              </div>
            </div>
            {/* Google */}
            <div className="p-2">
              <div className="grid grid-cols-2 gap-6  md:flex flex-col-reverse">
                <button
