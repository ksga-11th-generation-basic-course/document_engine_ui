                        ...
                        <div class="container mx-auto">
                            <div class="max-w-sm mx-auto md:max-w-lg">
                                ...
                                <div className="btn pt-8">
                                    <button type="button" class="transition  duration-200 bg-blue-400 hover:bg-blue-600 focus:bg-blue-700 focus:shadow-sm focus:ring-4 focus:ring-blue-500 focus:ring-opacity-50 text-white w-full py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-semibold text-center inline-block">
                                        Sign in
                                    </button>
                                </div>
                                </div>
