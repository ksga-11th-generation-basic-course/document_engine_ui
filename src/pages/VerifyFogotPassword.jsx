...
import page2 from '../assets/images/pagination/page2.svg'
import {
  resendVerifyCode,
  verifyOTP,
       ...
       <Link to="/" >
        ...
        <div className="flex justify-center items-center min-h-screen relative overflow-hidden">
          ...
          <div className="bg-white p-12 flex flex-col justify-center gap-y-6 rounded-3xl shadow-md">
                            ...
                            <div className="container mx-auto">
                              <div className="max-w-sm mx-auto md:max-w-lg">
                                <div className="w-full">
                                  <div className="bg-white h-72 rounded text-center">
                                    <div className="text">
                ...
                <div className=" absolute mt-[850px] ml-36">
                            <img src={page2} alt="page1" className="w-40"/>
                 </div>
          </div>
          <div>
