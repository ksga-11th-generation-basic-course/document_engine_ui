...
import EnableAccount from '../assets/reset_pw_popup/EnableAccount.svg'
import CloseIcon from '../assets/reset_pw_popup/closeIcon.svg'

function EnableAccountPopup() {
    return (
        <div>
                    ...
                    <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                        ...
                        <div className=" relative transform overflow-hidden rounded-lg bg-white text-left lg:shadow-xl transition-all sm:my-12 sm:w-full sm:max-w-lg ">
                            ...
                            <div className='flex flex-col justify-center items-center px-4 '>
                                <img src={EnableAccount} alt="" className='md:w-16' />
                            </div>
                            <form className="bg-white px-4  sm:p-6 sm:pb-4  ">
                                <div className="sm:flex justify-center">
                                    <div className=" text-center  sm:mt-0 sm:text-left">
                                        <h3 className=" text-baseleading-12 text-[#6B7280] flex justify-center font-normal " id="modal-title">Your account was closed. </h3>
                                        <h3 className=" text-baseleading-12 text-[#6B7280] flex justify-center font-normal mb-2" id="modal-title">Do you want to enable your account?</h3>
                            ...
                            <div className='mt-4 ml-2 flex justify-center'>
                                <button type="button" class=" hover:bg-secondary/90 text-black bg-[#FFFFFF] border focus:outline-none  font-semibold rounded-lg text-sm px-8 py-2.5  text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 mr-4 mb-10">
                                    No, cancel
                                </button>
