...
function JoinWorkspacePopup({ open, setOpen }) {
  return (
    <div>
      <div
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            <div className=" relative transform overflow-hidden rounded-lg bg-white text-left lg:shadow-xl transition-all sm:my-2 sm:w-full sm:max-w-lg ">
              <div className="flex justify-end pt-4 pr-4 cursor-pointer" onClick={() => setOpen(false)}>
                <img src={CloseIcon} alt="" className="" />
              </div>
              <div className="flex flex-col justify-center items-center px-4 ">
                <img src={JoinWorkspace} alt="" className="md:w-24" />
              </div>
              <form className="bg-white px-4 pb-4 sm:p-6 sm:pb-4 ">
                ...
                <div className="max-sm:w-72">
                  <input
                    type="text"
                    class="max-sm:w-[267px] max-sm:ml-2 sm:ml-12 sm:w-[375px] lg:ml-12 lg:w-[375px] md:ml-12 md:w-[375px] form-control block  py-2 text-base font-normal text-[#6B7280] bg-white bg-clip-padding  border border-solid border-[#1E9CEF] rounded-lg transition ease-in-out m-0 resize mt-6 "
                    placeholder=""
                  />
                </div>
              </form>
