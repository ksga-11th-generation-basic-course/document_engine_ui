...
import LeaveWorkspace from '../assets/reset_pw_popup/leavefromworkspace.svg'
import CloseIcon from '../assets/reset_pw_popup/closeIcon.svg'

function LeaveFromWorkpacePopup() {
  return (
    <div>
            ...
            <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                ...
                <div className=" relative transform overflow-hidden rounded-lg bg-white text-left lg:shadow-xl transition-all sm:my-12 sm:w-full sm:max-w-lg ">
                    ...
                    <div className='flex flex-col justify-center items-center px-4 '>
                        <img src={LeaveWorkspace} alt="" className='md:w-16' />
                    </div>
                    <form className="bg-white px-4 pb-4 sm:p-6 sm:pb-4 mt-4">
                        <div className="sm:flex justify-center">
                            <div className="mt-2 text-center  sm:mt-0 sm:text-left">
                                <h3 className=" text-baseleading-12 text-[#6B7280] flex justify-center font-normal" id="modal-title">Are you sure want to leave from this workspace?
                                   </h3>
...
export default LeaveFromWorkpacePopup