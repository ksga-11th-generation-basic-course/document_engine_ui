...
function WorkspaceCallaboratorMember({ open, setOpen }) {
  return (
    <div>
            ...
            <div className="w-[950px] bg-[#FFFFFF] flex col-span-10  shadow-content z-10 rounded-md">
              <div className="mt-10 px-32 ">
                <div className="">
                  {/* Header */}
                  <div>
                    <h1 className="font-bold text-4xl text-[#526581]">
                      Collabrators
                    </h1>
                    <p className="mt-2 text-20px text-[#526581]">
                      See all member in this
                    </p>
                  </div>
                  <div className="mt-7">
