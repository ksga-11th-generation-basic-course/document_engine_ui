    ...
    <div className="relative bg-white">
      <div className="grid grid-cols-12">
        <div className="col-span-2  z-10 md:col-span-12">
          ...
          <div className="hidden lg:inline-block md:inline-block">
            <div
              className={
                open
                  ...
                  : "hidden lg:flex lg:items-center lg:mt-9 md:flex md:mt-5"
              }
            >
            ...
            <div
              className={
                open
                  ? "hidden lg:inline-block lg:ml-10 lg:mt-24 lg:px-0 md:mt-14"
                  : "hidden lg:inline-block lg:ml-10 lg:mt-9 lg:px-0 md:mt-3 md:h-screen"
              }
            >
              <Outlet />
            </div>
        ...
        <div
          className={
            newWorkspace
              ? "col-span-10 h-screen overflow-y-auto lg:hidden z-0 md:hidden"
