        ...
        <div className= "col-span-2  z-10 md:col-span-12">
              ...
              <div className="hidden lg:inline-block md:inline-block">
                      <div className={sideBar ? "lg:flex lg:items-center md:px-5" : "hidden lg:flex lg:items-center lg:mt-9 md:flex md:mt-5"}>
                              ...
                              <div className={sideBar ? "hidden lg:inline-block lg:absolute lg:right-0 lg:mt-24 md:mt-16 lg:pr-10  lg:z-30 md:pr-3" : "hidden lg:inline-block lg:absolute lg:right-0 lg:z-30 md:inline-block md:absolute lg:pr-10  md:pr-2"}><NavBarProfile /></div>
                      </div> 
