      ...
      <div className="grid grid-cols-12">
        <div className= "col-span-2 shadow-sidebar z-10">
              ...
              <div className="hidden lg:inline-block md:inline-block">
                      ...
                      <div className={open ?  "hidden lg:inline-block lg:ml-10 lg:mt-24 lg:px-3" : "hidden lg:inline-block lg:ml-10 xs:ml-0 lg:mt-9 lg:px-3"}><Outlet /></div>
              </div>
        </div>
